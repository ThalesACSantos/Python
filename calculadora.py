    ...
    def calculate(operator, value_at):
        try:
            ...
            if operator == '%':
                ...
                if value >= 0:  # Verifica se o valor é não negativo
        ...
        digits = min(abs(Decimal(value).as_tuple().exponent), 7)
    ...
    def select(e):
        ...
        if value.isdigit():
            ...
            if value[-1] in ('=', '%', '±', '√'):
                ...
                page.update()  # Força a atualização da interface
